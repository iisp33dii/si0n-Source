...
Public Class cESP
    ...
    Public GlowPause As Boolean = False
    ...
    Public Sub GlowESPall(Esp As Boolean, ModelColor As Boolean)
        If Not GetAsyncKeyState(KeyBinds.SkinchangerKey) And Not GlowPause Then
    ...
    Public Function GetRenderColorFromGlowObject(GlowObject As GlowObject_t) As clr_s
        clr.r = CByte(255 * GlowObject.r)
        clr.g = CByte(255 * GlowObject.g)
        clr.b = CByte(255 * GlowObject.b)
        clr.a = CByte(255 * GlowObject.a)
        Return clr
    End Function
End Class