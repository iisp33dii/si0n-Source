...
Public Class Offsets
    ...
    Public Shared m_iObserverMode = &H3374
    ...
    Public Shared m_bDormant = FindPattern.Scanf(mem.ClientDLL, "8A81????????C332C0", 2, 8, False)
    ...
    Public Shared dwGlowObjectManager = FindPattern.Scanf(mem.ClientDLL, "A1????????A801754B", 1, 4, True)
    Public Shared dwLocalPlayer = FindPattern.Scanf(mem.ClientDLL, "8D3485????????8915????????8B41088B480483F9FF", 3, 4, True)
    ...
    Public Shared dwGlobalVars = FindPattern.Scanf(mem.EngineDLL, "68????????68????????FF500885C0", 1, 0, True)
